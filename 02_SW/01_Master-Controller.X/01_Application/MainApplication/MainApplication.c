...
MainApplication_LookUpTable LookUpTable_I2C[] = {
    {0x08, APP_PROTOCOL_CAN, 0x64},
    {0x09, APP_PROTOCOL_CAN, 0x6F}
};

MainApplication_LookUpTable LookUpTable_CAN[] = {
    {0x64, APP_PROTOCOL_I2C, 0x08},
    {0x6F, APP_PROTOCOL_I2C, 0x09}
};
...
void main(void)
{
    ...
    CAN_config.Module_BaudRate = CAN_1MBIT;
...
void MainApplication_vAddDataToBuffers()
{
    ...
    if ((DataToBeSent_CAN[0].ReadyForSending == true) && (false == DataToBeSent_CAN[0].DataWasSent))
    {
    ...
    //    {
    if ((true == DataToBeSent_I2C[DataToBeSent_I2C_ReadPointer].ReadyForSending) && (false == DataToBeSent_I2C[DataToBeSent_I2C_ReadPointer].DataWasSent))
    {
